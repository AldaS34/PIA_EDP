...
class Ventas:
    ...
    def registrar_cliente(self):
        while True:
            cliente_nom = input("Ingrese nombres del cliente (Escriba SALIR para vovler al menú): ")
            if cliente_nom.upper() == "SALIR":
                return 
            cliente_ap = input("Ingrese el apellido paterno: ")
            cliente_am = input("Ingrese el apellido materno (Solo presiona la tecla ENTER para omitir): ")
            if cliente_am == '':
                cliente_am == None
